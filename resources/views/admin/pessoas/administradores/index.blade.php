    ...
    <div class="container-tabela">
        <div class="btn-grp-tabela">
            <div class="btn-grp-principal">
                <a href={{ route('pessoas.administradores.adicionar') }} id="btn-adicionar">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const gridOptions = {
                ...
                columnDefs: [
                    { headerName: "Nome", field: "nome", filter: "agTextColumnFilter", sortable: true, flex: 1, minWidth: 130, sort: "asc" },
            ...
            document.getElementById("btn-excluir").addEventListener("click", function () {
                ...
                const baseUrl = "{{ url('admin/administradores') }}";

...
@push('scripts')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const tableData = @json($entrevistas);
            ...
            const gridOptions = {
                ...
                columnDefs: [
                    { headerName: "Candidato", field: "candidato.nome", filter: "agTextColumnFilter", sortable: true, flex: 2, minWidth: 160},
                    { headerName: "Agendador", field: "agendador.nome", filter: "agTextColumnFilter", sortable: true, flex: 2, minWidth: 160},
                    { headerName:  "Data e hora", field: "data_hora", filter: "agTextColumnFilter", sortable: true, flex: 1, minWidth: 140, sort: 'desc',  valueFormatter: params => {

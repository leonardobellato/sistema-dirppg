    ...
    <div class="container-tabela">
        <div class="btn-grp-tabela">
            <div class="btn-grp-principal">
                ...
                <button id="btn-visibilidade" disabled>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const gridOptions = {
                ...
                columnDefs: [
                    ...
                    { headerName: "Visível", field: "visivel", filter: "agTextColumnFilter", sortable: true, flex: 1, minWidth: 100, valueGetter: params => params.data.visivel ? "Sim" : "Não"},
                ],
                rowData: tableData,
                ...
                onSelectionChanged: function(event) {
                    ...
                    if(event.selectedNodes.length > 0){
                        ...
                        btnVisibilidade.disabled = false;
                        
                        // Atualiza o link para alterar o objeto específico
                        btnAlterar.classList.remove("disabled-link");
                        
                        const baseUrl = "{{ url('admin/disciplinas-aluno-externo/alterar') }}";
                        btnAlterar.href = `${baseUrl}/${gridApi.getSelectedRows()[0].id_disciplina}`;
                    } 
                    else{
                        btnExcluir.disabled = true;
                        btnVisibilidade.disabled = true;
            ...
            document.getElementById("btn-visibilidade").addEventListener("click", function () {
                const object = gridApi.getSelectedRows()[0];

                const baseUrl = "{{ url('admin/disciplinas-aluno-externo/visibilidade') }}";

                fetch(`${baseUrl}/${object.id_disciplina}`, {
                    method: "PATCH",
                    headers: {
                ...
                .then(data => {
                    object.visivel = data.visivel;
                    gridApi.applyTransaction({ update: [object] });
                    window.alert("Disciplina atualizada!");
                })
            ...
            document.getElementById("btn-excluir").addEventListener("click", function () {
                ...
                const baseUrl = "{{ url('admin/disciplinas-aluno-externo') }}";

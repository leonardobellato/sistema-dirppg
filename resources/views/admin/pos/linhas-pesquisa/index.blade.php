    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const gridOptions = {
                ...
                onSelectionChanged: function(event) {
                    ...
                    if(event.selectedNodes.length > 0){
                        ...
                        const baseUrl = "{{ url('admin/linhas-pesquisa/alterar') }}";
                        btnAlterar.href = `${baseUrl}/${gridApi.getSelectedRows()[0].id_linha_pesquisa}`;
                    } 
                    else{
            ...
            document.getElementById("btn-excluir").addEventListener("click", function () {
                ...
                const baseUrl = "{{ url('admin/linhas-pesquisa') }}";
                openModalDelete(object.nome, () => {
                    fetch(`${baseUrl}/${object.id_linha_pesquisa}`, {
                        method: "DELETE",
                        headers: {

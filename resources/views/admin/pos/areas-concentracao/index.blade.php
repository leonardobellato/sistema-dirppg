    ...
    <div class="container-tabela">
        <div class="btn-grp-tabela">
            <div class="btn-grp-principal">
                <a href={{ route('pos.areas-concentracao.adicionar') }} id="btn-adicionar">
...
@push('scripts')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const tableData = @json($areas_concentracao);
            ...
            const gridOptions = {
                ...
                columnDefs: [
                    { headerName: "Área", field: "nome", filter: "agTextColumnFilter", sortable: true, flex: 2, minWidth: 160, sort: "asc"},
            ...
            document.getElementById("btn-excluir").addEventListener("click", function () {
                ...
                const baseUrl = "{{ url('admin/areas-concentracao') }}";
                openModalDelete(object.nome, () => {
                    fetch(`${baseUrl}/${object.id_area_concentracao}`, {
                        method: "DELETE",
                        headers: {
                    ...
                    .then(response => {
                        ...
                        window.alert("Área de concentração excluída!");
                    })

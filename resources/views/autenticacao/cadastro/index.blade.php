    ...
    <main>
        <div class="login-container">
            ...
            <form action="{{ route('autenticacao.cadastro.salvar') }}" method="POST">
                ...
                <input type="text" id="input-nome" name="nome" class="simple-input" placeholder="Digite seu nome aqui" required>
                ...
                <input oninput="mascara(this)" type="text" id="input-cpf" name="cpf" class="simple-input" placeholder="Digite seu CPF aqui" required>

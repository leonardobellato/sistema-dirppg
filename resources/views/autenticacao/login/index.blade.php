        ...
        <div class="login-container">
            ...
            <form action="{{ route('autenticacao.login') }}" method="POST">
                ...
                <div class="input-container">
                    ...
                    <input type="text" name="email" id="input-email" class="input-field" placeholder="E-mail" required>
                </div>
                ...
                <div class="input-container">
                    ...
                    <input type="password" name="senha" id="input-senha" class="input-field" placeholder="Senha" required>
                </div>
